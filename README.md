# spidr has stopped releases in response to Google's support for the current US administration, which does not share truth or kindness. (Google is the primary contributor to OpenXLA, spidr's runtime.)
