...
spidr is in early development. Notably, we have yet to implement automatic differentiation, and [some exposed APIs](https://github.com/joelberkeley/spidr/issues/225) are not implemented.
