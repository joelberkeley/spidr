...
spidr is in early development. Notably, we have yet to implement automatic differentiation. See [here](https://github.com/joelberkeley/spidr/labels/notable%20limitation) for more limitations.
