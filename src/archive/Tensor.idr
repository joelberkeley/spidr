-- WE'LL USE THIS FOR A PROPER TENSOR LIB AT SOME POINT, BUT NOT NOW. FOR NOW,
-- WE'LL USE THE ARRAY LIBRARY FOR GPS
...
-- todo to write this to work with vectors? [m] -> [m, 1]
export
...
-- todo how to write this to work with vectors?
export partial
...
doubleToScalar : Double -> Tensor [] Double
...
-- todo a determinant doesn't transform as a scalar, so it shouldn't be a tensor
partial
